...
const Connect:FC = ( ) =>{
    ...
    <div className="container flex items-center justify-center px-4 mx-auto">
        <form className="w-full max-w-md">
            <div className="flex justify-center mx-auto font-bold text-teal-400">
                GET IN TOUCH
            ...
            <div className="relative flex items-center mt-4">
  <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Country</label>
