...
const Navbar:FC = () => {
  ...
  //  window && window.addEventListener("scroll", changeNavbarColor);
    ...
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <a className="flex title-font font-medium items-center mb-4 md:mb-0 dark:text-white">
        ...
        <Link href={"/"} className="text-l font-bold title-font tracking-widest">AuthCor</Link>
      </a>
      <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
        <Link className={`mr-5 hover:text-gray-900 ${pathname == "/" ? "active_nav" : ""}`} href="/" >Home</Link>
        <Link className={`mr-5 hover:text-gray-900 ${pathname == "/about" ? "active_nav" : ""}`} href="about" >About</Link>
        <Link className={`mr-5 hover:text-gray-900 ${pathname == "/services" ? "active_nav" : ""}`} href="services">Services</Link>
        <Link className={`mr-5 hover:text-gray-900 ${pathname == "/contact" ? "active_nav" : ""}`} href="contact" >Contact</Link>
